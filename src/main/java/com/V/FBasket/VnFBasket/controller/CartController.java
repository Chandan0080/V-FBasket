...
public class CartController {
    ...
    public ResponseEntity<?> updateCartItem(@RequestBody AddToCartRequestDTO dto) {
    ...
    public ResponseEntity<Map<String, String>> removeFromCart(@RequestBody AddToCartRequestDTO dto) {
